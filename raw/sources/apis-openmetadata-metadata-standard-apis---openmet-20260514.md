---
type: clip
title: "APIs | OpenMetadata Metadata Standard APIs - OpenMetadata Documentation"
url: "https://docs.open-metadata.org/v1.12.x/api-reference/main-concepts/metadata-standard/apis"
clipped: 2026-05-14
origin: web-clip
sources: []
tags: [web-clip]
...
# APIs | OpenMetadata Metadata Standard APIs - OpenMetadata Documentation

Source: https://docs.open-metadata.org/v1.12.x/api-reference/main-concepts/metadata-standard/apis

Skip to main contentOpenMetadata Documentation home pagev1.12.xSearch...⌘KSearch...NavigationMetadata StandardAPIs | OpenMetadata Metadata Standard APIsHomeQuickstartDeploymentConnectorsHow-to GuidesMCPAdmin GuideGuide for Data UsersData DiscoveryData ContractsData CollaborationData Quality and ObservabilityData Quality and ProfilerData Quality ObservabilityData LineageData InsightsData GovernanceReleasesDevelopersSDK & APIsAPI ReferenceIntroductionGetting StartedAuthenticationErrorsPaginationData AssetsOverviewDatabasesApi CollectionsApi EndpointsChartsContainersDashboard ServicesDashboardsDatabase SchemasDatabase ServicesDatabasesMessaging ServicesMlmodel ServicesMlmodelsPipeline ServicesPipelinesSearch IndexesStorage ServicesStored ProceduresTablesTopicsAI SDKAI SDKSDKOverviewOpenMetadata StandardsGo SDKPythonDiscoveryOverviewGETField QueryGETSearch EntitiesLineageOverviewGETGet LineagePUTAdd LineageDELDelete LineageGETExport LineageData ContractsOverviewPOSTCreate a Data ContractDELDelete a Data ContractGETList Data ContractsGETImport & ExportGETRetrieve a Data ContractPATCHUpdate a Data ContractPOSTValidate & ResultsGETData Contract VersionsTeams And UsersOverviewTeamsUsersData GovernanceOverviewClassificationsData ProductsDomainsGlossariesGlossary TermsTagsData QualityOverviewTest CasesTest DefinitionsTest SuitesMain ConceptsOverviewHigh Level DesignBackend DBMetadata StandardOverviewAPIsOn this pageAPIsOverviewURIResource RepresentationAPI OrganizationDocumentation IndexFetch the complete documentation index at: https://docs.open-metadata.org/llms.txtUse this file to discover all available pages before exploring further.​APIs
...
You can find the swagger documentation here. In a nutshell:
...
Was this page helpful?YesNoSuggest editsRaise issueMetadata Standard | OpenMetadata Core Schema GuidePrevious⌘I
