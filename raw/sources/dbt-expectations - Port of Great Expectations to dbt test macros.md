---
title: "calogica/dbt-expectations: Port(ish) of Great Expectations to dbt test macros"
source: https://github.com/calogica/dbt-expectations
author:
  - "[[GitHub]]"
published:
created: 2026-04-07
description: Port(ish) of Great Expectations to dbt test macros - calogica/dbt-expectations
tags:
  - clippings
  - dbt
  - data-quality
...
- [expect\_column\_to\_exist](https://github.com/calogica/dbt-expectations#expect_column_to_exist)
- [expect\_row\_values\_to\_have\_recent\_data](https://github.com/calogica/dbt-expectations#expect_row_values_to_have_recent_data)
- [expect\_grouped\_row\_values\_to\_have\_recent\_data](https://github.com/calogica/dbt-expectations#expect_grouped_row_values_to_have_recent_data)
- [expect\_table\_aggregation\_to\_equal\_other\_table](https://github.com/calogica/dbt-expectations#expect_table_aggregation_to_equal_other_table)
- [expect\_table\_column\_count\_to\_be\_between](https://github.com/calogica/dbt-expectations#expect_table_column_count_to_be_between)
- [expect\_table\_column\_count\_to\_equal\_other\_table](https://github.com/calogica/dbt-expectations#expect_table_column_count_to_equal_other_table)
- [expect\_table\_column\_count\_to\_equal](https://github.com/calogica/dbt-expectations#expect_table_column_count_to_equal)
- [expect\_table\_columns\_to\_not\_contain\_set](https://github.com/calogica/dbt-expectations#expect_table_columns_to_not_contain_set)
- [expect\_table\_columns\_to\_contain\_set](https://github.com/calogica/dbt-expectations#expect_table_columns_to_contain_set)
- [expect\_table\_columns\_to\_match\_ordered\_list](https://github.com/calogica/dbt-expectations#expect_table_columns_to_match_ordered_list)
- [expect\_table\_columns\_to\_match\_set](https://github.com/calogica/dbt-expectations#expect_table_columns_to_match_set)
- [expect\_table\_row\_count\_to\_be\_between](https://github.com/calogica/dbt-expectations#expect_table_row_count_to_be_between)
- [expect\_table\_row\_count\_to\_equal\_other\_table](https://github.com/calogica/dbt-expectations#expect_table_row_count_to_equal_other_table)
- [expect\_table\_row\_count\_to\_equal\_other\_table\_times\_factor](https://github.com/calogica/dbt-expectations#expect_table_row_count_to_equal_other_table_times_factor)
- [expect\_table\_row\_count\_to\_equal](https://github.com/calogica/dbt-expectations#expect_table_row_count_to_equal)

### Missing values, unique values, and types

- [expect\_column\_values\_to\_be\_null](https://github.com/calogica/dbt-expectations#expect_column_values_to_be_null)
- [expect\_column\_values\_to\_not\_be\_null](https://github.com/calogica/dbt-expectations#expect_column_values_to_not_be_null)
- [expect\_column\_values\_to\_be\_unique](https://github.com/calogica/dbt-expectations#expect_column_values_to_be_unique)
- [expect\_column\_values\_to\_be\_of\_type](https://github.com/calogica/dbt-expectations#expect_column_values_to_be_of_type)
- [expect\_column\_values\_to\_be\_in\_type\_list](https://github.com/calogica/dbt-expectations#expect_column_values_to_be_in_type_list)
- [expect\_column\_values\_to\_have\_consistent\_casing](https://github.com/calogica/dbt-expectations#expect_column_values_to_have_consistent_casing)

### Sets and ranges

- [expect\_column\_values\_to\_be\_in\_set](https://github.com/calogica/dbt-expectations#expect_column_values_to_be_in_set)
- [expect\_column\_values\_to\_not\_be\_in\_set](https://github.com/calogica/dbt-expectations#expect_column_values_to_not_be_in_set)
- [expect\_column\_values\_to\_be\_between](https://github.com/calogica/dbt-expectations#expect_column_values_to_be_between)
- [expect\_column\_values\_to\_be\_decreasing](https://github.com/calogica/dbt-expectations#expect_column_values_to_be_decreasing)
- [expect\_column\_values\_to\_be\_increasing](https://github.com/calogica/dbt-expectations#expect_column_values_to_be_increasing)

### String matching

- [expect\_column\_value\_lengths\_to\_be\_between](https://github.com/calogica/dbt-expectations#expect_column_value_lengths_to_be_between)
- [expect\_column\_value\_lengths\_to\_equal](https://github.com/calogica/dbt-expectations#expect_column_value_lengths_to_equal)
- [expect\_column\_values\_to\_match\_like\_pattern](https://github.com/calogica/dbt-expectations#expect_column_values_to_match_like_pattern)
- [expect\_column\_values\_to\_match\_like\_pattern\_list](https://github.com/calogica/dbt-expectations#expect_column_values_to_match_like_pattern_list)
- [expect\_column\_values\_to\_match\_regex](https://github.com/calogica/dbt-expectations#expect_column_values_to_match_regex)
- [expect\_column\_values\_to\_match\_regex\_list](https://github.com/calogica/dbt-expectations#expect_column_values_to_match_regex_list)
- [expect\_column\_values\_to\_not\_match\_like\_pattern](https://github.com/calogica/dbt-expectations#expect_column_values_to_not_match_like_pattern)
- [expect\_column\_values\_to\_not\_match\_like\_pattern\_list](https://github.com/calogica/dbt-expectations#expect_column_values_to_not_match_like_pattern_list)
- [expect\_column\_values\_to\_not\_match\_regex](https://github.com/calogica/dbt-expectations#expect_column_values_to_not_match_regex)
- [expect\_column\_values\_to\_not\_match\_regex\_list](https://github.com/calogica/dbt-expectations#expect_column_values_to_not_match_regex_list)

### Aggregate functions

- [expect\_column\_distinct\_count\_to\_be\_greater\_than](https://github.com/calogica/dbt-expectations#expect_column_distinct_count_to_be_greater_than)
- [expect\_column\_distinct\_count\_to\_be\_less\_than](https://github.com/calogica/dbt-expectations#expect_column_distinct_count_to_be_less_than)
- [expect\_column\_distinct\_count\_to\_equal\_other\_table](https://github.com/calogica/dbt-expectations#expect_column_distinct_count_to_equal_other_table)
- [expect\_column\_distinct\_count\_to\_equal](https://github.com/calogica/dbt-expectations#expect_column_distinct_count_to_equal)
- [expect\_column\_distinct\_values\_to\_be\_in\_set](https://github.com/calogica/dbt-expectations#expect_column_distinct_values_to_be_in_set)
- [expect\_column\_distinct\_values\_to\_contain\_set](https://github.com/calogica/dbt-expectations#expect_column_distinct_values_to_contain_set)
- [expect\_column\_distinct\_values\_to\_equal\_set](https://github.com/calogica/dbt-expectations#expect_column_distinct_values_to_equal_set)
- [expect\_column\_max\_to\_be\_between](https://github.com/calogica/dbt-expectations#expect_column_max_to_be_between)
- [expect\_column\_mean\_to\_be\_between](https://github.com/calogica/dbt-expectations#expect_column_mean_to_be_between)
- [expect\_column\_median\_to\_be\_between](https://github.com/calogica/dbt-expectations#expect_column_median_to_be_between)
- [expect\_column\_min\_to\_be\_between](https://github.com/calogica/dbt-expectations#expect_column_min_to_be_between)
- [expect\_column\_most\_common\_value\_to\_be\_in\_set](https://github.com/calogica/dbt-expectations#expect_column_most_common_value_to_be_in_set)
- [expect\_column\_proportion\_of\_unique\_values\_to\_be\_between](https://github.com/calogica/dbt-expectations#expect_column_proportion_of_unique_values_to_be_between)
- [expect\_column\_quantile\_values\_to\_be\_between](https://github.com/calogica/dbt-expectations#expect_column_quantile_values_to_be_between)
- [expect\_column\_stdev\_to\_be\_between](https://github.com/calogica/dbt-expectations#expect_column_stdev_to_be_between)
- [expect\_column\_sum\_to\_be\_between](https://github.com/calogica/dbt-expectations#expect_column_sum_to_be_between)
- [expect\_column\_unique\_value\_count\_to\_be\_between](https://github.com/calogica/dbt-expectations#expect_column_unique_value_count_to_be_between)

### Multi-column

- [expect\_column\_pair\_values\_A\_to\_be\_greater\_than\_B](https://github.com/calogica/dbt-expectations#expect_column_pair_values_a_to_be_greater_than_b)
- [expect\_column\_pair\_values\_to\_be\_equal](https://github.com/calogica/dbt-expectations#expect_column_pair_values_to_be_equal)
- [expect\_column\_pair\_values\_to\_be\_in\_set](https://github.com/calogica/dbt-expectations#expect_column_pair_values_to_be_in_set)
- [expect\_compound\_columns\_to\_be\_unique](https://github.com/calogica/dbt-expectations#expect_compound_columns_to_be_unique)
- [expect\_multicolumn\_sum\_to\_equal](https://github.com/calogica/dbt-expectations#expect_multicolumn_sum_to_equal)
- [expect\_select\_column\_values\_to\_be\_unique\_within\_record](https://github.com/calogica/dbt-expectations#expect_select_column_values_to_be_unique_within_record)

### Distributional functions

- [expect\_column\_values\_to\_be\_within\_n\_moving\_stdevs](https://github.com/calogica/dbt-expectations#expect_column_values_to_be_within_n_moving_stdevs)
- [expect\_column\_values\_to\_be\_within\_n\_stdevs](https://github.com/calogica/dbt-expectations#expect_column_values_to_be_within_n_stdevs)
- [expect\_row\_values\_to\_have\_data\_for\_every\_n\_datepart](https://github.com/calogica/dbt-expectations#expect_row_values_to_have_data_for_every_n_datepart)
...
### expect\_column\_values\_to\_have\_consistent\_casing
...
Expect column entries to be strings with length between a min\_value value and a max\_value value (inclusive).
...
### expect\_column\_distinct\_count\_to\_equal
...
### expect\_column\_distinct\_count\_to\_be\_greater\_than
...
### expect\_column\_distinct\_count\_to\_be\_less\_than
...
### expect\_column\_distinct\_count\_to\_equal\_other\_table
...
Expect the column mean to be between a min\_value value and a max\_value value (inclusive).
...
Expect the column median to be between a min\_value value and a max\_value value (inclusive).
...
Expect specific provided column quantiles to be between provided min\_value and max\_value values.
...
Expect the column standard deviation to be between a min\_value value and a max\_value value. Uses sample standard deviation (normalized by N-1).
...
Expect the number of unique values to be between a min\_value value and a max\_value value.
...
Expect the proportion of unique values to be between a min\_value value and a max\_value value.
...
### expect\_select\_column\_values\_to\_be\_unique\_within\_record
...
### expect\_multicolumn\_sum\_to\_equal
...
### expect\_compound\_columns\_to\_be\_unique
...
- If `test_start_date` or `test_end_date` are not specified, the test automatically determines the `min` / `max` of the specified `date_col` from your data, respectively. On some platforms, and/or if your table is not partitione on that date column, this may lead to performance issues. In these cases, we recommend setting an explicit date literal. You may also set a "dynamic" date literal via the built-in `modules.datetime` functions:
```
date_part: day
...
![](https://raw.githubusercontent.com/calogica/dbt-expectations/main/expectations.gif)