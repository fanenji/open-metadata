---
type: clip
title: "External Profiler Workflow | Official Documentation - OpenMetadata Documentation"
url: "https://docs.open-metadata.org/v1.12.x/how-to-guides/data-quality-observability/profiler/external-workflow"
clipped: 2026-05-14
origin: web-clip
sources: []
tags: [web-clip]
...
# External Profiler Workflow | Official Documentation - OpenMetadata Documentation

Source: https://docs.open-metadata.org/v1.12.x/how-to-guides/data-quality-observability/profiler/external-workflow

Skip to main contentOpenMetadata Documentation home pagev1.12.xSearch...⌘KSearch...NavigationData ProfilerExternal Profiler Workflow | Official DocumentationHomeQuickstartDeploymentConnectorsHow-to GuidesMCPAdmin GuideGuide for Data UsersData DiscoveryData ContractsData CollaborationData Quality and ObservabilityData Quality and ProfilerData Quality ObservabilityData LineageData InsightsData GovernanceReleasesDevelopersSDK & APIsData Quality and ObservabilityOverviewData QualityData ProfilerOverviewProfiler WorkflowMetricsCustom MetricsExternal workflowAlerts & NotificationsIncident ManagerOn this pageExternal Profiler WorkflowRequirements1. Define the YAML Config2. Run the WorkflowRun the Workflow with the CLIRun the Workflow from Python using the SDKDocumentation IndexFetch the complete documentation index at: https://docs.open-metadata.org/llms.txtUse this file to discover all available pages before exploring further.​External Profiler Workflow
...
will be shared on its documentation page.
...
You can get details of how to define a yaml file for data profiler for each connector here.
...
Was this page helpful?YesNoSuggest editsRaise issueCustom MetricsPreviousAlerts & Notifications | OpenMetadata GuideNext⌘I
