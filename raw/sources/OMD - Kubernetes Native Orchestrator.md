...
source: "https://docs.open-metadata.org/v1.12.x/deployment/ingestion/kubernetes"
author:
published:
created: 2026-05-14
...
For validating your setup, viewing pipeline logs, troubleshooting, and migrating from Airflow, see the [Operations & Troubleshooting](https://docs.open-metadata.org/v1.12.x/deployment/ingestion/kubernetes/troubleshooting) guide.