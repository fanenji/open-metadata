...
source: https://docs.getdbt.com/blog/introducing-dbt-mcp-server
author:
  - "[[Jason Ganz]]"
...
![Three use‑case pillars of the dbt MCP server](https://docs.getdbt.com/img/blog/2025-04-18-dbt-mcp-server/mcp_use_cases.png?v=2)
...
![How the dbt MCP server fits between data sources and MCP‑enabled clients](https://docs.getdbt.com/img/blog/2025-04-18-dbt-mcp-server/mcp_architecture_overview.png?v=2)
...
![Claude Desktop – MCP server running in Developer settings](https://docs.getdbt.com/img/blog/2025-04-18-dbt-mcp-server/claudedesktop_settings_dbt_mcp.png?v=2)
...
![Example Claude Desktop project connected to the dbt MCP server](https://docs.getdbt.com/img/blog/2025-04-18-dbt-mcp-server/claudedesktop_project_card.png?v=2)
