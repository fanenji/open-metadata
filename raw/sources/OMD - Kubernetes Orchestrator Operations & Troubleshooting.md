...
source: "https://docs.open-metadata.org/v1.12.x/deployment/ingestion/kubernetes/troubleshooting"
author:
published:
created: 2026-05-14
...
type: "note"
---
This guide covers validating your Kubernetes orchestrator setup, viewing pipeline logs, troubleshooting common issues, and migrating from Airflow. For initial setup, see the [Kubernetes Native Orchestrator](https://docs.open-metadata.org/v1.12.x/deployment/ingestion/kubernetes) guide.
