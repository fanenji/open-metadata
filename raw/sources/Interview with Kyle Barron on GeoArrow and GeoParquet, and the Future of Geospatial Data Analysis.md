...
source: https://cloudnativegeo.org/blog/2024/12/interview-with-kyle-barron-on-geoarrow-and-geoparquet-and-the-future-of-geospatial-data-analysis/
author:
published: 2024-12-11
created: 2026-04-04
description: Kyle Barron, Cloud Engineer at Development Seed, builds open source tools and infrastructure that process and visualize geospatial data.
tags:
  - clippings
  - mapping
topic:
type: note
---
![Kyle Barron](https://cloudnativegeo.org/images/20241209-kylebarron.png)
...
introduced support for spatial partitioning. This makes it possible to fetch only specific rows of a file according to a spatial filter.

![GeoParquet File](https://cloudnativegeo.org/images/20241209-geoparquetfile_hu_9ba10be6c5bd616.png)
...
Our blog is open source. You can [suggest edits on GitHub](https://github.com/cloudnativegeo/cloudnativegeo.org/blob/main/content/blog/241212-interview-kylebarron.md).