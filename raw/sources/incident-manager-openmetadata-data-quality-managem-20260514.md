---
type: clip
title: "Incident Manager | OpenMetadata Data Quality Management - OpenMetadata Documentation"
url: "https://docs.open-metadata.org/v1.12.x/how-to-guides/data-quality-observability/incident-manager"
clipped: 2026-05-14
origin: web-clip
sources: []
tags: [web-clip]
...
# Incident Manager | OpenMetadata Data Quality Management - OpenMetadata Documentation

Source: https://docs.open-metadata.org/v1.12.x/how-to-guides/data-quality-observability/incident-manager

Skip to main contentOpenMetadata Documentation home pagev1.12.xSearch...⌘KSearch...NavigationIncident ManagerIncident Manager | OpenMetadata Data Quality ManagementHomeQuickstartDeploymentConnectorsHow-to GuidesMCPAdmin GuideGuide for Data UsersData DiscoveryData ContractsData CollaborationData Quality and ObservabilityData Quality and ProfilerData Quality ObservabilityData LineageData InsightsData GovernanceReleasesDevelopersSDK & APIsData Quality and ObservabilityOverviewData QualityData ProfilerAlerts & NotificationsIncident ManagerOverviewHow to work with the Incident ManagerOn this pageOverview of the Incident ManagerOpening and Triaging IncidentsUsing the Test Resolution FlowIncidents Context & HistoryBuilding a Troubleshooting HandbookSteps to Get StartedDocumentation IndexFetch the complete documentation index at: https://docs.open-metadata.org/llms.txtUse this file to discover all available pages before exploring further.​Overview of the Incident Manager
...
Failure Notification: When a Data Quality Test fails, the system generates a notification.

Acknowledge the Failure: The designated user acknowledges the issue within the Incident Manager.

Assignment: The issue is then assigned to a knowledgeable user or team responsible for resolving it.

Status Updates: The assigned user can update the status of the issue, keeping the organization informed about progress and any developments.

Sharing Updates: All impacted users receive updates, ensuring everyone stays informed about the resolution process.
...
Access the Incident Manager: Navigate to the Incident Manager within the OpenMetadata platform.

Monitor Data Quality Tests: Keep an eye on your data quality tests to quickly identify any failures.

Acknowledge and Assign: Acknowledge any issues promptly and assign them to the appropriate team members.

Log and Learn: Document the root cause of each failure and use the stored information to learn and improve.
...
How to work with the Incident ManagerSet up the Incident Manager workflow.Was this page helpful?YesNoSuggest editsRaise issueGeneric Webhook Alert Configuration | OpenMetadataPreviousHow to work with the Incident Manager | Official DocumentationNext⌘I
