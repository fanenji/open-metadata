---
title: "luatnc87/modern-data-warehouse-modeling-and-data-quality-with-dbt-openmetadata: This repository serves as a comprehensive guide to effective data modeling and robust data quality assurance using popular open-source tools"
source: https://github.com/luatnc87/modern-data-warehouse-modeling-and-data-quality-with-dbt-openmetadata
author:
  - "[[luatnc87]]"
published:
created: 2026-04-04
description: This repository serves as a comprehensive guide to effective data modeling and robust data quality assurance using popular open-source tools - luatnc87/modern-data-warehouse-modeling-and-data-quality-with-dbt-openmetadata
tags:
  - clippings
  - data-quality
  - architecture
...
[![architecture.png](https://github.com/luatnc87/modern-data-warehouse-modeling-and-data-quality-with-dbt-openmetadata/raw/main/images%2Farchitecture.png)](https://github.com/luatnc87/modern-data-warehouse-modeling-and-data-quality-with-dbt-openmetadata/blob/main/images%2Farchitecture.png)

## The contents

- [Understanding the Tools](https://github.com/luatnc87/modern-data-warehouse-modeling-and-data-quality-with-dbt-openmetadata#understanding-the-tools)
- [Understanding the Modeling techniques](https://github.com/luatnc87/modern-data-warehouse-modeling-and-data-quality-with-dbt-openmetadata#understanding-the-modeling-techniques)
- [Hybrid Data Modeling Approach: Dimensional Model + One Big Table](https://github.com/luatnc87/modern-data-warehouse-modeling-and-data-quality-with-dbt-openmetadata#hybrid-data-modeling-approach-dimensional-model--one-big-table)
- [Setting up DuckDB, dbt, OpenMetadata, and Mate with Docker Compose](https://github.com/luatnc87/modern-data-warehouse-modeling-and-data-quality-with-dbt-openmetadata#setting-up-duckdb-dbt-openmetadata-and-mate-with-docker-compose)
- [Creating the structure of the dbt project](https://github.com/luatnc87/modern-data-warehouse-modeling-and-data-quality-with-dbt-openmetadata#creating-the-structure-of-the-dbt-project)
- [Start building models](https://github.com/luatnc87/modern-data-warehouse-modeling-and-data-quality-with-dbt-openmetadata#start-building-models)
- [Ensuring data quality](https://github.com/luatnc87/modern-data-warehouse-modeling-and-data-quality-with-dbt-openmetadata#ensuring-data-quality)
- [Making data it accessible, understandable and usable for users](https://github.com/luatnc87/modern-data-warehouse-modeling-and-data-quality-with-dbt-openmetadata#making-data-it-accessible-understandable-and-usable-for-users)
- [Automate jobs with Apache Airflow](https://github.com/luatnc87/modern-data-warehouse-modeling-and-data-quality-with-dbt-openmetadata#automate-jobs-with-apache-airflow)
- [Conclusion](https://github.com/luatnc87/modern-data-warehouse-modeling-and-data-quality-with-dbt-openmetadata#conclusion)
...
- **Key Characteristics**:
	- Data is organized into structured star or snowflake schemas, optimizing query performance for analytical workloads.
		- Normalization reduces data redundancy and enforces data integrity. Fact tables contain numerical measures, and dimension tables provide context and attributes.
...
OpenMetadata provides a default admin account to login. You can access OpenMetadata at *[http://localhost:8585](http://localhost:8585/)*. Use the following credentials to log in to OpenMetadata.

- Username: *admin*
- Password: *admin*

Once you log in, you can goto *Settings -> Users* to add another user and make them admin as well. [![openmetadata_login.png](https://github.com/luatnc87/modern-data-warehouse-modeling-and-data-quality-with-dbt-openmetadata/raw/main/images%2Fopenmetadata_login.png)](https://github.com/luatnc87/modern-data-warehouse-modeling-and-data-quality-with-dbt-openmetadata/blob/main/images%2Fopenmetadata_login.png)
...
[![openmetadata_airflow.png](https://github.com/luatnc87/modern-data-warehouse-modeling-and-data-quality-with-dbt-openmetadata/raw/main/images%2Fopenmetadata_airflow.png)](https://github.com/luatnc87/modern-data-warehouse-modeling-and-data-quality-with-dbt-openmetadata/blob/main/images%2Fopenmetadata_airflow.png)
...
[![star_schema.png](https://github.com/luatnc87/modern-data-warehouse-modeling-and-data-quality-with-dbt-openmetadata/raw/main/images%2Fstar_schema.png)](https://github.com/luatnc87/modern-data-warehouse-modeling-and-data-quality-with-dbt-openmetadata/blob/main/images%2Fstar_schema.png)

> **NOTE**: There are two main types of Dimensional Models that are often used today: **Star Schema** and **Snowflake Schema**
...
Get a better sense of what the records look like by executing select statements using your database's SQL editor. For example:

```
SELECT * FROM marts.obt_sales LIMIT 100
```

[![select_obt.png](https://github.com/luatnc87/modern-data-warehouse-modeling-and-data-quality-with-dbt-openmetadata/raw/main/images%2Fselect_obt.png)](https://github.com/luatnc87/modern-data-warehouse-modeling-and-data-quality-with-dbt-openmetadata/blob/main/images%2Fselect_obt.png)
...
Navigating to *[http://localhost:8888](http://localhost:8888/)* to view data lineage

[![data_lineage.png](https://github.com/luatnc87/modern-data-warehouse-modeling-and-data-quality-with-dbt-openmetadata/raw/main/images%2Fdata_lineage.png)](https://github.com/luatnc87/modern-data-warehouse-modeling-and-data-quality-with-dbt-openmetadata/blob/main/images%2Fdata_lineage.png)
...
You can find generated sql for each test case in the *target/run/..path-to-model../* directory. Example:
...
Integrating Great Expectations with dbt is a powerful way to expand your testing capabilities and enhance data quality assurance within your dbt projects. Great Expectations allows you to define, document, and validate expectations about your data, providing a comprehensive approach to data testing. Here's a step-by-step guide to integrating Great Expectations with dbt:
...
The first step, we need to install *fal* library to be able to use python script in dbt models. Add *dbt-fal==1.5.9* into the *requirements.txt* file, and run following command:

```
pip install -r requiremnets.txt
```

You can find the *scripts/fal/slack\_bot.py* file that will be executed via **dbt-fal run** command.
...
After running *dbt-fal run --proflile-dir. --models dim\_address*, you should be received the alert message on the Slack channel, example: [![slack_alerts.png](https://github.com/luatnc87/modern-data-warehouse-modeling-and-data-quality-with-dbt-openmetadata/raw/main/images%2Fslack_alerts.png)](https://github.com/luatnc87/modern-data-warehouse-modeling-and-data-quality-with-dbt-openmetadata/blob/main/images%2Fslack_alerts.png)
...
| [![openmetadata_duckdb_service.png](https://github.com/luatnc87/modern-data-warehouse-modeling-and-data-quality-with-dbt-openmetadata/raw/main/images%2Fopenmetadata_duckdb_service.png)](https://github.com/luatnc87/modern-data-warehouse-modeling-and-data-quality-with-dbt-openmetadata/blob/main/images%2Fopenmetadata_duckdb_service.png) |
| --- |
| *Database metadata* |

| [![openmetadata_duckdb_marts_obt_sales.png](https://github.com/luatnc87/modern-data-warehouse-modeling-and-data-quality-with-dbt-openmetadata/raw/main/images%2Fopenmetadata_duckdb_marts_obt_sales.png)](https://github.com/luatnc87/modern-data-warehouse-modeling-and-data-quality-with-dbt-openmetadata/blob/main/images%2Fopenmetadata_duckdb_marts_obt_sales.png) |
| --- |
| *Models metadata* |

| [![openmetadata_duckdb_marts_obt_sales_dbt_tab.png](https://github.com/luatnc87/modern-data-warehouse-modeling-and-data-quality-with-dbt-openmetadata/raw/main/images%2Fopenmetadata_duckdb_marts_obt_sales_dbt_tab.png)](https://github.com/luatnc87/modern-data-warehouse-modeling-and-data-quality-with-dbt-openmetadata/blob/main/images%2Fopenmetadata_duckdb_marts_obt_sales_dbt_tab.png) |
| --- |
| *dbt SQL code* |
...
[![airflow_dag.png](https://github.com/luatnc87/modern-data-warehouse-modeling-and-data-quality-with-dbt-openmetadata/raw/main/images%2Fairflow_dag.png)](https://github.com/luatnc87/modern-data-warehouse-modeling-and-data-quality-with-dbt-openmetadata/blob/main/images%2Fairflow_dag.png)

Now, turn on your DAG, enable Auto-refresh, and trigger a run. All your tasks should complete successfully and turn green!

[![run_dbt_airflow.png](https://github.com/luatnc87/modern-data-warehouse-modeling-and-data-quality-with-dbt-openmetadata/raw/main/images%2Frun_dbt_airflow.png)](https://github.com/luatnc87/modern-data-warehouse-modeling-and-data-quality-with-dbt-openmetadata/blob/main/images%2Frun_dbt_airflow.png)
...
- [4 data modeling techniques for modern data warehouses](https://www.getdbt.com/blog/data-modeling-techniques)
...
- [Dimensional modeling](https://docs.getdbt.com/terms/dimensional-modeling)
- [Building a Kimball dimensional model with dbt](https://docs.getdbt.com/blog/kimball-dimensional-model)
- [How To Use DBT To Bring Dimensions To Your Data](https://data-sleek.com/blog/modern-data-warehouse-modeling-with-dbt/)
- [Designing and Building the Data Warehouse](https://robinphetsavongdata.wordpress.com/2019/06/18/part-1-designing-and-building-the-data-warehous/)
- [Port(ish) of Great Expectations to dbt test macros](https://github.com/calogica/dbt-expectations)
- [How to integrate dbt with Slack](https://blog.fal.ai/how-to-dbt-slack-integration/)
- [OpenMetadata - Ingest dbt cli](https://docs.open-metadata.org/v1.1.0/connectors/ingestion/workflows/dbt/ingest-dbt-cli)
- [Creating a Custom Connector](https://github.com/open-metadata/openmetadata-demo/blob/main/custom-connector/README.md)
- [Build OpenMetadata Source](https://docs.open-metadata.org/v1.1.x/sdk/python/build-connector/source)
- [OpenMetadata and dbt: For an Integrated View of Data Assets](https://atlan.com/openmetadata-dbt/?ref=/openmetadata-ingestion/)
- [Airflow and dbt, Hand in Hand](https://www.astronomer.io/blog/airflow-and-dbt/#airflow-and-dbt-core)
- [Running dbt with Airflow](https://www.datafold.com/blog/running-dbt-with-airflow)
