...
source: https://huggingface.co/blog/duckdb-nsql-7b
author:
  - "[[Andrea Soria]]"
  - "[[Till Döhmen]]"
  - "[[Sen Wu]]"
...
[Update on GitHub](https://github.com/huggingface/blog/blob/main/duckdb-nsql-7b.md)
...
- **ddl\_create** will be the dataset schema as a SQL `CREATE` command
- **query\_input** will be the user instructions, expressed with natural language
...
- Now, we can construct the prompt with the **ddl\_create** and the **query** input
...
<video alt="Demo"><source src="https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/duckdb-nsql-7b/demo.mp4" type="video/mp4"></video>
...
More Articles from our Blog[llmintelnlp](https://huggingface.co/blog/intel-qwen3-agent)
...
[View original](https://huggingface.co/blog/intel-qwen3-agent)[transformersllmguide](https://huggingface.co/blog/accelerate-nd-parallel)
...
[View original](https://huggingface.co/blog/accelerate-nd-parallel)