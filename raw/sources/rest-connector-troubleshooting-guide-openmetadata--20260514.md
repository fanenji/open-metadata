---
type: clip
title: "REST Connector Troubleshooting Guide | OpenMetadata Support - OpenMetadata Documentation"
url: "https://docs.open-metadata.org/v1.12.x/connectors/api/rest/troubleshooting"
clipped: 2026-05-14
origin: web-clip
sources: []
tags: [web-clip]
...
# REST Connector Troubleshooting Guide | OpenMetadata Support - OpenMetadata Documentation

Source: https://docs.open-metadata.org/v1.12.x/connectors/api/rest/troubleshooting

Skip to main contentOpenMetadata Documentation home pagev1.12.xSearch...⌘KSearch...NavigationRESTREST Connector Troubleshooting Guide | OpenMetadata SupportHomeQuickstartDeploymentConnectorsHow-to GuidesMCPAdmin GuideGuide for Data UsersData DiscoveryData ContractsData CollaborationData Quality and ObservabilityData Quality and ProfilerData Quality ObservabilityData LineageData InsightsData GovernanceReleasesDevelopersSDK & APIsConnectorsConnectorsConnectorAPIOverviewRESTOverviewRun ExternallyTroubleshootingDatabaseDashboardMessagingPipelineML ModelStorageSearchMetadataDriveCustom ConnectorsConnector IngestionIngestionOn this pageTroubleshootingWorkflow Deployment ErrorConnector Debug TroubleshootingHow to Enable Debug Logging for Any IngestionPermission IssuesDocumentation IndexFetch the complete documentation index at: https://docs.open-metadata.org/llms.txtUse this file to discover all available pages before exploring further.​Troubleshooting
...
If you encounter permission-related errors during connector setup or metadata ingestion, ensure that all the prerequisites and access configurations specified for each connector are properly implemented. Refer to the connector-specific documentation to verify the required permissions.Was this page helpful?YesNoSuggest editsRaise issueRun the OpenAPI/REST Connector ExternallyPreviousDatabase Services | OpenMetadata Connector IntegrationNext⌘I
