---
source_url: "https://github.com/kestra-io/mcp-server-python"
fetched: "2026-04-21"
title: "kestra-io/mcp-server-python: Python MCP Server for Kestra"
author: ""
published: ""
...
See [kestra\_mcp\_docker](https://github.com/kestra-io/mcp-server-python/blob/main/docs/flows/kestra_mcp_docker.yaml).
...
Create an `.env` file in the root directory of the project similar to the [.env\_example](https://github.com/kestra-io/mcp-server-python/blob/main/.env_example) file. For OSS installations, you can use basic authentication with `KESTRA_USERNAME` and `KESTRA_PASSWORD`. For EE/Cloud installations, use `KESTRA_API_TOKEN`. To disable Enterprise Edition tools in OSS, add `KESTRA_MCP_DISABLED_TOOLS=ee` to your `.env` file.
...
[![img.png](https://github.com/kestra-io/mcp-server-python/raw/main/docs/images/vscode1.png)](https://github.com/kestra-io/mcp-server-python/blob/main/docs/images/vscode1.png)
...
[![img_1.png](https://github.com/kestra-io/mcp-server-python/raw/main/docs/images/vscode2.png)](https://github.com/kestra-io/mcp-server-python/blob/main/docs/images/vscode2.png)

If you click on continue, you will see the result of the command in the output window.

[![img_2.png](https://github.com/kestra-io/mcp-server-python/raw/main/docs/images/vscode3.png)](https://github.com/kestra-io/mcp-server-python/blob/main/docs/images/vscode3.png)
